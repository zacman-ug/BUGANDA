  ...
  return (
    <Layout setView={setView} currentView={view} onFamilyTreeClick={handleFamilyTreeClick}>
      ...
      <div className="mb-12 relative overflow-hidden">
        ...
        <div className="relative z-10 flex justify-between items-center bg-gradient-to-br from-heritage-dark via-gray-900 to-black text-white rounded-3xl p-10 shadow-heritage-lg border-2 border-heritage-gold/20 hover:border-heritage-gold/40 transition-all duration-300">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-3">
              <span className="text-5xl">👑</span>
              <h1 className="text-5xl font-bold font-serif text-transparent bg-clip-text bg-gradient-to-r from-heritage-gold to-yellow-300">Buganda Archives</h1>
            </div>
            <p className="text-gray-300 text-lg font-serif italic pl-20">"Where every ancestor's story becomes immortal..."</p>
          </div>

          <div className="flex gap-3 ml-8">
            <button
              onClick={() => setShowExportPanel(true)}
              className="relative overflow-hidden bg-gradient-to-r from-green-500 via-emerald-400 to-green-600 text-white px-6 py-3 rounded-2xl font-bold shadow-heritage-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-110 whitespace-nowrap group before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-white before:translate-y-full hover:before:translate-y-0 before:transition-transform before:duration-300"
            >
              <span className="relative z-10 group-hover:text-green-600 transition-colors duration-300">📥 Export</span>
            </button>
            <button
              onClick={() => setShowAdvancedSearch(!showAdvancedSearch)}
              className="relative overflow-hidden bg-gradient-to-r from-blue-500 via-blue-400 to-blue-600 text-white px-6 py-3 rounded-2xl font-bold shadow-heritage-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-110 whitespace-nowrap group before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-white before:translate-y-full hover:before:translate-y-0 before:transition-transform before:duration-300"
            >
            ...
            <button
              ...
              className="relative overflow-hidden bg-gradient-to-r from-heritage-gold via-yellow-400 to-heritage-bronze text-heritage-dark px-10 py-3 rounded-2xl font-bold text-lg shadow-heritage-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-110 whitespace-nowrap ml-4 group before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-gradient-to-r before:from-heritage-dark before:to-black before:translate-y-full hover:before:translate-y-0 before:transition-transform before:duration-300"
            >
